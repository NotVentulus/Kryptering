...
public class readFile {
    ...
    public static void main(String[] args) throws IOException {
        ...
        File inFile = new File("C:\\Users\\svos14\\Documents\\cripted.txt");
        File outFile = new File ("C:\\Users\\svos14\\Documents\\decrip.txt");
...
//            while ((line = reader.readLine()) != null) {
        ...
        crypt.close();
        write.close();
        System.out.print("Dekryptering färdig");
